        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskActivities_Employees_ActorId",
                        column: x => x.ActorId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskChecklistItems_Employees_CompletedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskTimeEntries_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskWatchers", x => new { x.TaskId, x.EmployeeId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskDependencies_BlockedTaskId_BlockingTaskId",
                table: "TaskDependencies",
                columns: new[] { "BlockedTaskId", "BlockingTaskId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskTimeEntries_EmployeeId",
